...
describe AlbumsController do
  ...
  before(:each) do
     @current_user = User.create(:name => 'admin',:password => 'password')
     session[:user_id] = @current_user.id
  end 
  def valid_attributes
    {:name => 'Album Name',:user_id => @current_user.id}
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested album" do
        ...
        Album.any_instance.should_receive(:update_attributes).with({'these' => 'params'},{:updated_at=>Date.today})
